...
$vehicleModels = $newVehicle->selectVehicleModels();
$vehicleTypes = $newVehicle->selectVehicleTypes();
$fuelType = $newVehicle->selectFuelTypes();
$vehicles = $newVehicle->selectAllVehicles();


if (isset($_GET['search'])) {
    $input = $_GET['search'];
    $vehicles = $newVehicle->searchVehicle($input);
}

if ($_POST) {

    $vehicleEdit = $newVehicle->searchVehicleForEdit();
